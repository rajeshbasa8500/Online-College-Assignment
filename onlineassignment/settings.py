"""
Django settings for onlineassignment project.
...
SECRET_KEY = 'django-insecure-k%!%d=$4dg_%y5^1crmbefc$w#4vz+o^mxuk)vd1+c#1(9x4d6'
...
ROOT_URLCONF = 'onlineassignment.urls'
...
WSGI_APPLICATION = 'onlineassignment.wsgi.application'
